...
//
//    JDBCDataManager(DataSource dataSource) {
//        this.dataSource = dataSource;
//    }
//
//    @Override
//    public String getNote(Owner owner, String title) throws SQLException {
//        String result;
...
//
//    @Override
//    public void updateNote(Owner owner, String title, String newText) throws SQLException {
//        connection = dataSource.getConnection();
...
//
//    @Override
//    public void setPrivileges(String noteTitle, User user, int newRights) throws SQLException {
//        connection = dataSource.getConnection();
...
//
//    @Override
//    public List<Note> getNotes(Owner owner) throws SQLException {
//        connection = dataSource.getConnection();
//
...
//                bufUserPassword = resultSetUsers.getInt("privilege");
//                userList.add(new User(bufUserId, bufUserName, bufUserMail));
//            }
//            statementUser.close();
//            bufNotes.add(new Note(id, bufTitle, owner, bufText, userList, noteCrDate));
//        }
//        connection.close();
//        return bufNotes;
//    }
